...
pip3 install tidalapi requests urllib3 pystray pillow qrcode -t "$INSTALL_DIR/libs" --no-cache-dir --upgrade
...
Priority: optional
Architecture: all
Depends: python3, python3-gi, python3-cairo, gir1.2-gtk-4.0, gir1.2-adw-1, python3-gst-1.0, gstreamer1.0-plugins-good, gstreamer1.0-plugins-bad, gstreamer1.0-plugins-ugly
