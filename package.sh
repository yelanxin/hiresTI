...
FEDORA_REQUIRES="python3, python3-gobject, python3-cairo, python3-pyopengl, python3-setproctitle, gtk4, libadwaita, webkitgtk6.0, xdg-dbus-proxy, gstreamer1-plugins-base, gstreamer1-plugins-good, gstreamer1-plugins-bad-free, gstreamer1-plugins-ugly-free, pipewire, pipewire-gstreamer, pulseaudio-libs, alsa-lib, libusb1, mesa-libGL, mesa-libEGL, mesa-dri-drivers, libglvnd-glx, libglvnd-egl"
